...
- `dist\HdrSdrBrightness-1.0.9-win64.msix`
...
powershell -ExecutionPolicy Bypass -File .\package-msix.ps1 -Version 1.0.9 -SkipBuild

# Create only the MSIX, without the Partner Center upload wrapper.
powershell -ExecutionPolicy Bypass -File .\package-msix.ps1 -Version 1.0.9 -SkipUpload

# Include an optional symbol package if one is generated later.
powershell -ExecutionPolicy Bypass -File .\package-msix.ps1 -Version 1.0.9 -AppxSymPath .\dist\HdrSdrBrightness-1.0.9-win64.appxsym
```
