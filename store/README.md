...
```powershell
powershell -ExecutionPolicy Bypass -File .\package-msix.ps1 -Version 1.1.0 -Clean
```

Expected outputs:

- `dist\HdrSdrBrightness-1.1.0-win64.msix`
- `dist\HdrSdrBrightness-1.1.0-win64.msixupload`
...
powershell -ExecutionPolicy Bypass -File .\package-msix.ps1 -Version 1.1.0 -SkipBuild

# Create only the MSIX, without the Partner Center upload wrapper.
powershell -ExecutionPolicy Bypass -File .\package-msix.ps1 -Version 1.1.0 -SkipUpload

# Include an optional symbol package if one is generated later.
powershell -ExecutionPolicy Bypass -File .\package-msix.ps1 -Version 1.1.0 -AppxSymPath .\dist\HdrSdrBrightness-1.1.0-win64.appxsym
```
